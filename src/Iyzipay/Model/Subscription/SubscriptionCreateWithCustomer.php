...
use FriendsOfBotble\Iyzipay\Iyzipay\Model\Mapper\Subscription\SubscriptionCreateMapper;
use FriendsOfBotble\Iyzipay\Iyzipay\Options;
use FriendsOfBotble\Iyzipay\Iyzipay\Request\Subscription\SubscriptionCreateWithCustomerRequest;

class SubscriptionCreateWithCustomer extends IyzipayResource
{
    ...
    public static function create(SubscriptionCreateWithCustomerRequest $request, Options $options)
    {
        $uri = $options->getBaseUrl() . '/v2/subscription/initialize/with-customer';
